...
export const attendanceApi = {
  ...
  requestVerify: (coords) => api.post('/attendance/clock-in/request-verify', coords || {}),
  pendingRequests: () => api.get('/attendance/clock-in/pending-requests'),
  approveRequest: (requestId) => api.post(`/attendance/clock-in/approve/${requestId}`),
  requestClockOutOtp: (body) => api.post('/attendance/clock-out/request-otp', body || {}),
  verifyClockOut: (otpCode) => api.post('/attendance/clock-out/verify', { otpCode }),
