        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EMEmployeesId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OTPid = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanEditAttendance = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    CanAccessAdminPanel = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Emaillogsid = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    OtpUserRequestId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokedReason = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, true, true, true, true, true, true, true, true, new DateTime(2026, 2, 25, 12, 36, 19, 495, DateTimeKind.Utc).AddTicks(9408), "Full system access", true, "Admin", null },
                    { 2, false, false, true, true, true, false, false, true, true, new DateTime(2026, 2, 25, 12, 36, 19, 495, DateTimeKind.Utc).AddTicks(9412), "Manager level access", true, "Manager", null },
                    { 3, false, false, false, false, false, false, false, true, false, new DateTime(2026, 2, 25, 12, 36, 19, 495, DateTimeKind.Utc).AddTicks(9414), "Basic user access", true, "User", null }
                });
